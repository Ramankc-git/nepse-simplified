...
export const newsletters: NewsletterData[] = [
  ...
  },
  {
    ...
    stocks: [
      {
        ...
        badgeColor: "blue",
        reasoning:
          "Nabil Bank showing signs of consolidation near support. Monitor volume for breakout confirmation.",
        tip: "Wait for confirmed breakout above resistance with volume before entering.",
      },
      {
        symbol: "EBL",
        badge: "Developing",
        badgeColor: "green",
        reasoning:
          "Everest Bank showing pattern development. Watch for fundamental confirmation from quarterly results.",
        tip: "Monitor next quarterly report for NPL and CASA trends before taking position.",
      },
    ],
    iposAndAuctions: [
    ...
    ltp: "Check sharesansar.com",
    weeklyHigh: "Check sharesansar.com",
    trend: "Consolidating",
    description:
      "Nabil Bank is Nepal's largest commercial bank by market capitalization. Monitor quarterly reports for NPL trends, CASA ratio, and net interest margin changes.",
    strategicOpinion:
      "As the bellwether of the banking sector, NABIL's price action often leads the broader index. Watch for volume confirmation on any breakout.",
    supportZone: "Check chart",
